...
class GetCurrentTeriffMatrixTestCase(unittest.TestCase):
...
class CalculateMinutesCostTestCase(unittest.TestCase):
  	def test_normal_calculate_minutes_cost(self):
   		price_of_hour = "10"
   		minutes = 15
   		self.assertIsInstance(calculate_minutes_cost(price_of_hour, minutes), float, "calculate_minutes_cost function returns incorrent value.") 
...
class ParseTariffToListTestCase(unittest.TestCase):
  	def test_normal_parse_tariff_to_list(self):
   		tarrif = "10|50"
   		self.assertIsInstance(parse_tariff_to_list(tarrif), tuple, "parse_tariff_to_list function returns incorrent value.") 
